...
interface MtechEducationFormProps {
    data: any;
    onChange: (field: string, value: any) => void;
}

const MtechEducationForm: React.FC<MtechEducationFormProps> = ({
    data,
    onChange,
}) => (
    <div className="space-y-10 animate-in fade-in duration-700">
        <div className="bg-white border-2 border-slate-100 overflow-hidden rounded-xl shadow-sm relative">
            <div className="bg-slate-50 px-8 py-4 border-b-2 border-slate-100 flex items-center justify-between">
                <h3 className="text-[11px] font-black text-slate-900 uppercase tracking-[0.2em] flex items-center gap-2">
                    <GraduationCap className="h-3.5 w-3.5 text-[#8BB723]" />
                    M.Tech Education Details
                </h3>
            ...
            <div className="p-8 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
                ...
                <div className="space-y-3">
                    ...
                    <input
                        ...
                        className="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-[#8BB723] focus:bg-white outline-none transition-all font-bold text-slate-700 tracking-wide uppercase"
                        required
                    />
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-[#8BB723] focus:bg-white outline-none transition-all font-bold text-slate-700 uppercase appearance-none cursor-pointer"
                            required
                        >
                ...
                <div className="space-y-3">
                    ...
                    <div className="relative">
                        <select
                            ...
                            className="w-full px-5 py-4 bg-slate-50 border-2 border-slate-100 rounded-xl focus:border-[#8BB723] focus:bg-white outline-none transition-all font-bold text-slate-700 appearance-none cursor-pointer"
                            required
                        >
...
export default MtechEducationForm;
