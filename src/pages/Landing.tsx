...
export function Landing() {
    ...
    const handleRegister = async () => {
        ...
        const doRegister = async () => {
            // 1. Record the phase for analytics
            await recordPhase("registration", email, formData.phone)

            // 2. Actually create the user in the database
            const res = await fetch(apiUrl("/api/student/register"), {
                ...
                body: JSON.stringify({
                    ...
                    program: formData.program, // This is 'phd'
            ...
            if (!res.ok) {
                ...
                throw new Error(err?.detail || "Registration failed on server")
            }
